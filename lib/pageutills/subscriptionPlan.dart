    ...
    if (Platform.isAndroid) {
      ...
      if (result['success']) {
        ...
        if (subscriptionCreated) {
          ...
          _showErrorDialog(context, "Payment successful but failed to activate subscription.");
        }
      } else {
        _showErrorDialog(context, "Payment failed: ${result['error']}");
      }
      ...
      // final productId = "com.myapp.subscription_$planId"; // Match App Store ID
      // final response = await _inAppPurchase.queryProductDetails({productId});

      // if (response.notFoundIDs.isNotEmpty) {
      //   _showErrorDialog(context, "Product not found in App Store.");
      //   return;
      // }
      ...
      //       if (subscriptionCreated) {
      //         _showSuccessDialog(context, planName, purchase.purchaseID ?? "");
      //       } else {
      //         _showErrorDialog(context, "Purchase done but subscription not activated.");
      //       }
      //     } else if (purchase.status == PurchaseStatus.error) {
      //       _showErrorDialog(context, "Purchase failed: ${purchase.error}");
      //     }
      //   }
      // });
    }
