...
import 'package:try_app/pageutills/PrivacyPolicyPage.dart';
import 'package:try_app/pageutills/term_condtion.dart';
import 'package:url_launcher/url_launcher.dart';
import '../../pageutills/ReturnRefundPolicyPage.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _launchDeleteAccountURL() async {
    final Uri url = Uri.parse('https://torentyou.com/base/contact_us');
    try {
      ...
      if (!launched && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Could not open the contact page. Please try again.'),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Subscription section - Only visible on Android
                        if (Platform.isAndroid) ...[
                          const _SectionHeader(text: 'Subscription'),
                          _ProfileOptionItem(
                            ...
                            onTap: () {
                              if (userId != null) {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        SubscriptionPlanPage(userId: userId!),
                                  ),
                                );
                              }
                            },
                        ...
                        _ProfileOptionItem(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    const ChatListLookingforScreen(),
                              ),
                            );
                          },
                        ),
                        ...
                        const _SectionHeader(text: 'Privacy & Terms'),
                        _ProfileOptionItem(
                        ...
                        _ProfileOptionItem(
                          ...
                          onTap: () {
                            // Show confirmation dialog before opening the URL
                            showDialog(
                              context: context,
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  content: const Text(
                                      'This will take you to our contact page where you can request account deletion. Do you want to continue?'),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
