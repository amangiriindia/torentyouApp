...
//             SnackBar(
//               content:
//                   Text('${validImages.length} image(s) added successfully!'),
...
//         duration =
//             "$value $unit${int.tryParse(value) != null && int.parse(value) > 1 ? 's' : ''}";
//       } else {
//         duration = "";
//       }
//     });
...
//                           value: null, child: Text('No categories available'))
//                     ]
...
//                         decoration:
//                             _inputDecoration(hintText: 'Enter Duration'),
              ...
              children: [
                Expanded(
                  child: RadioListTile<String>(
                    ...
                    value: 'days',
                    groupValue: selectedDurationType,
                    onChanged: (value) {
                      setState(() {
                        selectedDurationType = value;
                        updateDuration();
