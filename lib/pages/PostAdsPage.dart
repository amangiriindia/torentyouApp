...
//     durationValueController.dispose(); // Add this line
//     super.dispose();
//   }
//
...
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(
//             content: Text('Unsupported image format: .$extension. Please select JPG, PNG, or other supported formats.'),
//             backgroundColor: Colors.orange,
//           ),
//         );
//         return false;
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(
//           content: Text('This image file appears to be corrupted or in an unsupported format. Please try another image.'),
...
//   }
//
// // Updated _pickFromGallery method with validation
...
//           bool isValid = await _validateImageFile(image);
//           if (isValid) {
...
//         }
//
//         // Show message about invalid images if any
//         if (invalidCount > 0) {
//           ScaffoldMessenger.of(context).showSnackBar(
//             SnackBar(
//               content: Text('$invalidCount image(s) could not be added due to format or quality issues.'),
//               backgroundColor: Colors.orange,
//             ),
//           );
//         }
...
//   }
//
// // Updated _pickFromCamera method with validation
...
//
//       if (photo != null) {
//         bool isValid = await _validateImageFile(photo);
//         if (isValid) {
//           setState(() {
//             _images.add(photo);
//           });
...
//   }
//
// // Updated image display widget with error handling
...
//
//
// // Optional: Add method to show options for adding more images after initial selection
...
//   }
//
// // Add method to clear all images
...
//         durationValueController.text.isEmpty || // Updated validation
//         selectedDurationType == null || // Updated validation
//         packageOption == null) {
//       ScaffoldMessenger.of(context).showSnackBar(
...
//                     // Dropdown for Duration Type (Days/Months)
//                     Expanded(
//                       flex: 1,
...
//                 Expanded(
//                   child: GestureDetector(
//                     onTap: _pickImages, // Call _pickImages to show options
//                     child: Container(
...
//             const SizedBox(height: 10),
//
//           // Display the selected images with enhanced UI
//             if (_images.isNotEmpty)
//               Container(
//                 constraints: const BoxConstraints(maxHeight: 120),
//                 child: SingleChildScrollView(
